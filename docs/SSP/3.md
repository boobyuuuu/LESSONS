...
$$
u_{lj\sigma}=A_{j\sigma\boldsymbol{q}}\mathrm{e}^{\mathrm{i}(\boldsymbol{q}\cdot\boldsymbol{R}_l-\boldsymbol{\omega}t)}
$$

得到方程组：

$$
m_{j}\boldsymbol{\omega}^{2}A_{{j\boldsymbol{\sigma}\boldsymbol{q}}}=\sum_{{j^{\prime}\boldsymbol{\sigma}^{\prime}}}\left[\sum_{{l-l^{\prime}}}\boldsymbol{\lambda}_{{j\boldsymbol{\sigma}j^{\prime}\boldsymbol{\sigma}^{\prime}}}(\boldsymbol{R}_{\iota}-\boldsymbol{R}_{{\iota^{\prime}}})\operatorname{e}^{{-\mathrm{i}\boldsymbol{q}\cdot\boldsymbol{R}_{{l-l^{\prime}}}}}\right]A_{{j^{\prime}\boldsymbol{\sigma}^{\prime}\boldsymbol{q}}}=\sum_{{j^{\prime}\boldsymbol{\sigma}^{\prime}}}\boldsymbol{\lambda}_{{j\boldsymbol{\sigma}j^{\prime}\boldsymbol{\sigma}^{\prime}}}(\boldsymbol{q})A_{{j^{\prime}\boldsymbol{\sigma}^{\prime}\boldsymbol{q}}}
$$

系数行列式=0，得到3n个色散关系：

$$
\mid\lambda_{j\sigma j^{\prime}\sigma^{\prime}}(\boldsymbol{q})-\boldsymbol{\omega}^2m_j\delta_{jj^{\prime}}\delta_{\sigma\sigma^{\prime}}\mid_{3n\times3n}=0
$$
...
$$
\boldsymbol{q}=\frac{h_1}{N_1}\boldsymbol{b}_1+\frac{h_2}{N_2}\boldsymbol{b}_2+\frac{h_3}{N_3}\boldsymbol{b}_3=\sum_i\frac{h_i}{N_i}\boldsymbol{b}_i
$$
...
$$
P_{n_{\boldsymbol{q}s}}=\mathrm{e}^{-\beta n_{\boldsymbol{q}s}\hbar\omega_s(\boldsymbol{q})}/\sum_{n_{\boldsymbol{q}s}}\mathrm{e}^{-\beta n_{\boldsymbol{q}s}\hbar\omega_s(\boldsymbol{q})}
$$

振子 $\hbar \omega$ 的平均声子占有数：

$$
n_{\boldsymbol{q}s}(T)=\frac1{\mathrm{e}^{\beta\hbar\omega_s(q)}-1}
$$
...
$$
\varepsilon_{qs}(T)=\langle\varepsilon_{qs}\rangle=\left[n_{qs}(T)+\frac12\right]\hbar\omega_s(\boldsymbol{q}),\quad s=1,2,3,\cdots,3n
$$
...
$$
\frac{\omega^2}{c^2}\boldsymbol{P}-\boldsymbol{q}(\boldsymbol{q}\cdot\boldsymbol{P})\\\boldsymbol{E}=\frac{c^2}{\boldsymbol{\varepsilon}_0(q^2-\boldsymbol{\omega}^2/c^2)}
$$
...
&=-\int_0^W\boldsymbol{F}\cdot\mathrm{d}\boldsymbol{W}-\int_0^E\boldsymbol{P}\cdot\mathrm{d}\boldsymbol{E}\\
& F=b_{11}\boldsymbol{W}, P=P_{_\text{位移}}+P_{_\text{电子}}=b_{_{12}}\boldsymbol{W}+b_{_{22}}\boldsymbol{E}\\
&=-\left(\frac{1}{2}b_{11}\boldsymbol{W}^{2}+b_{12}\boldsymbol{W}\cdot\boldsymbol{E}+\frac{1}{2}b_{22}\boldsymbol{E}^{2}\right)
\end{aligned}
$$

带入正则方程 $p=\frac{\partial L}{\partial\dot{\boldsymbol{W}}}$,$\dot{p}=-\frac{\partial H}{\partial W}$：

$$
\ddot{\boldsymbol{W}}=b_{_{11}}\boldsymbol{W}+b_{_{12}}\boldsymbol{E}
$$
...
$$
\boldsymbol{P}=b_{_{21}}\boldsymbol{W}+b_{_{22}}\boldsymbol{E}
$$
